...
xst -ifn xst.scr
move Clock50MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock50MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock50MHz_exdes.ucf Clock50MHz_exdes

echo 'Running map'
map -timing -pr b Clock50MHz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock50MHz_exdes -w routed.ncd routed.v
cd ..
