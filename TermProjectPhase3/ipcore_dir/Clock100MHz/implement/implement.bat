...
xst -ifn xst.scr
move Clock100MHz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock100MHz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock100MHz_exdes.ucf Clock100MHz_exdes

echo 'Running map'
map -timing -pr b Clock100MHz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm Clock100MHz_exdes -w routed.ncd routed.v
cd ..
